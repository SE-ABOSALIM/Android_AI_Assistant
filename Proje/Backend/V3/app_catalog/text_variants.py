...
from V3.resources.latin_arabic_transliteration import ARABIC_TO_LATIN_TRANSLITERATION
from V3.app_catalog.text_normalization import _fast_tokens, _normalize_words, _split_compound_words
