...
from V3.services.extractors import (
    extract_alarm_text,
...
from V3.services.text_utils import normalized_lower
from V3.services.validation.app_matching import enrich_app_command
